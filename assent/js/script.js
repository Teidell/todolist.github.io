...
let tareasArray = [
  ...
  { id: 60, tarea: "Estudiar para la prueba", completada: false },
  { id: 24, tarea: "Sacar a pasear a tobby", completada: false },
];

const buttonAdd = document.getElementById("buttonAdd");
const nuevaEntrada = document.getElementById("nuevaEntrada");
  ...
  for (let hacer of tareasArray)
    html += `
            <div class="tareasContainer">
                ...
                <div class="t_check" id="t_check">
                    <input type="checkbox" onclick="check(${hacer.id})" ${
      hacer.completada ? "checked" : null
    }>
                </div>
                <div class="t_btn" id="t_btn">
                    <i class="fa-solid fa-rectangle-xmark fa-lg" style="color: #fe0606;" onclick="borrar(${
                      hacer.id
                    })"></i>
